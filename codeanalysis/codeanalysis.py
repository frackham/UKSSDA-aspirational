...
def ca_analysepython(rootpath, currentfile, resultsList):
    #HACK: Note the open() calls. This is probably quite inefficient, but shouldn't be an issue until/unless the project gets very big.
...
$(document).ready(function(){
 $("div").click(function(event){
  ...
  var line1=""" + str(codeAnalystsDataList) + """var plot2 = $.jqplot('chartdiv', [line1], {
